...
var urlIdsList = [ 'bf1bfc9a62f74acf92318fc177d71bd6' ];
...
var loadModel = function ( callback ) {
    ...
    if ( window.location.host.indexOf( 'sketchfab-local' ) !== -1 ) {
        client._url = 'https://sketchfab-local.com/models/XXXX/embed?autostart=1&carmel=0&messaging=1&scrollwheel=0&ui_controls=0&ui_infos=0&ui_snapshots=0&ui_stop=0&ui_watermark=0&vr_menu=1&vr_ar=1#VWR:ready;';
    }
